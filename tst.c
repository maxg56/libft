...
// Fonction de test pour ft_isalpha
...
// Fonction de test pour ft_isdigit
...
// Fonction de test pour ft_isascii
...
// Fonction de test pour ft_isprint
...
void test_ft_memcmp() {
    char str1[] = "Hello";
    char str2[] = "Hello";
    printf("Testing ft_memcmp: %d\n", ft_memcmp(str1, str2, 5)); // Devrait imprimer 0
}
